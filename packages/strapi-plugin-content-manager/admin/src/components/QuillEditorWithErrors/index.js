...
class QuillEditorWithErrors extends React.Component { // eslint-disable-line react/prefer-stateless-function
...
QuillEditorWithErrors.defaultProps = {
  autoFocus: false,
  className: '',
...
QuillEditorWithErrors.propTypes = {
...
export default QuillEditorWithErrors;
